      ...
      <div className="container-custom">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="bg-amber-50 border-l-4 border-amber-600 p-6 rounded-r-lg">
            <p className="text-amber-800 font-medium mb-2">Health Disclaimer</p>
            <p className="text-amber-700">
              The statements made about these products have not been evaluated by the Food and Drug Administration. 
              These products are not intended to diagnose, treat, cure, or prevent any disease. Please consult your 
              healthcare provider before starting any supplement regimen.
            </p>
            <Link 
              to="/disclaimer" 
              className="inline-block mt-2 text-amber-600 hover:text-amber-700 underline"
            >
