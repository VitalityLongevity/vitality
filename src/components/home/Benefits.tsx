      ...
      <div className="container-custom relative">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
           Sea moss is one of nature’s most powerful superfoods, offering remarkable benefits from dissolving excess mucus and slowing signs of aging to improving digestion and fighting iron deficiency. Packed with <b>92 of the 102</b> essential minerals our bodies need, it also helps <b>flush out toxins, supports natural detoxification, and can aid in healthy weight loss</b>—making it a complete solution for whole-body wellness.
          </p>
        </div>
